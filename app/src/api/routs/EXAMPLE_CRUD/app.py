...
@app.get("/api/EXAMPLE_CRUD/users", response_model=ManyUsersResponse, tags=['profile'])
...
@app.post("/api/EXAMPLE_CRUD/user/new", response_model=GetUserResponse, tags=['profile'])
...
@app.put("/api/EXAMPLE_CRUD/user/edit/me", response_model=GetUserResponse, tags=['profile'])
...
@app.delete("/api/EXAMPLE_CRUD/user/delete/me", response_model=OkMessageResponse, tags=['profile'])
